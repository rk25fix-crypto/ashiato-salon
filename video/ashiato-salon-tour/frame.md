...
typography:
  # — reading + chrome ramp —
  body:    { fontFamily: "Noto Sans JP", cqw: 1.56, weight: 400, lineHeight: 1.38 }
  body-card:{ fontFamily: "Noto Sans JP", cqw: 1.35, weight: 400, lineHeight: 1.34 }
  label:   { fontFamily: "JetBrains Mono", px: 26, cqw: 1.35, weight: 600, tracking: "0.18em", upper: true }
  caption-mono:{ fontFamily: "JetBrains Mono", px: 24, cqw: 1.25, weight: 600, tracking: "0.14em", upper: true }
  # — display ramp (Arial weight 500, opsz, negative tracking) —
  title-card-sm:{ fontFamily: "Noto Serif JP", cqw: 2.9, weight: 600, lineHeight: 0.98, tracking: "-0.01em" }
  title-card:{ fontFamily: "Noto Serif JP", cqw: 3.5, weight: 600, lineHeight: 0.96, tracking: "-0.01em" }
  headline:{ fontFamily: "Noto Serif JP", cqw: 4.4, weight: 600, lineHeight: 1.0, tracking: "-0.02em" }
  headline-xl:{ fontFamily: "Noto Serif JP", cqw: 5.0, weight: 600, lineHeight: 0.96, tracking: "-0.02em" }
  display:{ fontFamily: "Noto Serif JP", cqw: 7.3, weight: 600, lineHeight: 1.02, tracking: "-0.02em" }
  display-hero:{ fontFamily: "Noto Serif JP", cqw: 11.5, weight: 600, lineHeight: 0.92, tracking: "-0.02em" }
  stat-figure:{ fontFamily: "Noto Serif JP", cqw: 11.5, weight: 600, lineHeight: 0.92, tracking: "-0.03em" }
  stat-figure-unit:{ fontFamily: "Noto Serif JP", cqw: 5.7, weight: 600, lineHeight: 0.92 }
  name:    { fontFamily: "Noto Serif JP", cqw: 2.3, weight: 600, lineHeight: 1.0 }
...
> **Hand adjustment (ashiato-salon):** build-frame mapped the brand onto a brown primary; re-pointed the color keys to the site's own tokens (--deep #A8506A, --deep-2 #8A3D56, --green #7D5560, --cream #FBF1F0, --paper #FFFDFA, --ink #4A3A3F; pink = light rose tint for text on deep). Display ramp uses Noto Serif JP (the site sets headings in a Mincho serif — Georgia/"Yu Mincho"); reading ramp uses Noto Sans JP (site body is a Gothic sans). Canvas for this video is 1080×1920 (9:16).
